...
const pContaiberRef = document.createElement('p')

task6Ref.appendChild(pContaiberRef)

window.addEventListener('resize', () =>
// task6Ref.insertAdjacentHTML('afterend', `<p class="text"> witdth: ${window.innerWidth}, height: ${window.innerHeight}</p>`)

pContaiberRef.innerText = `witdth: ${window.innerWidth}, height: ${window.innerHeight}`
...
const task7Ref = document.getElementById('country');
...
////variant vise-versa when u can select city and get country. 
//******************************************* */

// const citiesContainerRef = document.getElementById('cities');
// const countryContainerRef = document.querySelectorAll('#country option')

// citiesContainerRef.addEventListener('change', (event) =>{
   
//     countryContainerRef.forEach(function(item, i){
//         if(item.hasAttribute('selected')){
//             item.removeAttribute("selected") 
//          }
...
///variant with array of elements




// const citiesArray = {
//     'ger': ['Baden-Baden', 'Essen', 'Munster'],
//     'usa': ['Milwakee', 'Albuquerque', 'Quantico'],
//     'ukr': ['Mariupol', 'Kovel', 'Mukacheve']
// }
...
// task7Ref.addEventListener('change', modification)

// function modification (){
//     citiesContainerRef.innerHTML = '';
//     let countrySelected = task7Ref.value;
//         for(let i = 0; i < citiesArray[countrySelected].length; i+=1){
//             let optionElementRef = document.createElement('option');
//             optionElementRef.innerHTML = citiesArray[countrySelected][i];
//             citiesContainerRef.appendChild(optionElementRef)
//         }
// }