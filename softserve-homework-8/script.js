...
//     if((/^[A-Za-z0-9]+([-]?)\w*$/).test(emailBody) && (/\w\./i).test(emailEnd) && checkExp.length === 1){
//         console.log('true')
//     }   else console.log('false')
// }
...
function checkLogin(login){
    ...
    } else if ((/^[A-Za-z]/i).test(login) && login.match(/\d\.\d/) && login.length <= 10){
        console.log('true');
        console.log(login.match(/\d\.\d/))
    }
